...
const lecture04: Explanation = {
  ...
  lesson: 4,
  title: {
    de: "Symmetrische Kryptografie: AES und die Betriebsmodi", en: "Symmetric cryptography: AES and the modes of operation", tr: "Simetrik şifreleme: AES ve çalışma modları", ar: "التشفير المتماثل: AES وأوضاع التشغيل", ru: "Симметричная криптография: AES и режимы работы", it: "Crittografia simmetrica: AES e le modalità operative", es: "Criptografía simétrica: AES y los modos de operación.", fr: "Cryptographie symétrique : AES et les modes de fonctionnement", zh: "对称加密：AES 和操作模式", pl: "Kryptografia symetryczna: AES i sposoby działania", pt: "Criptografia simétrica: AES e os modos de operação", uk: "Симетрична криптографія: AES і режими роботи", fa: "رمزنگاری متقارن: AES و حالت های عملیات", ja: "対称暗号化: AES と動作モード", ko: "대칭 암호화: AES 및 작동 모드", vi: "Mật mã đối xứng: AES và các phương thức hoạt động", hi: "सममित क्रिप्टोग्राफी: एईएस और संचालन के तरीके", ur: "سمیٹرک کرپٹوگرافی: AES اور آپریشن کے طریقے", nl: "Symmetrische cryptografie: AES en de werkingsmodi", el: "Συμμετρική κρυπτογραφία: AES και τρόποι λειτουργίας", cs: "Symetrická kryptografie: AES a způsoby provozu", hu: "Szimmetrikus kriptográfia: AES és a működési módok", ro: "Criptografia simetrică: AES și moduri de operare", sq: "Kriptografia simetrike: AES dhe mënyrat e funksionimit", sr: "Симетрична криптографија: АЕС и начини рада", hr: "Simetrična kriptografija: AES i načini rada", bg: "Симетрична криптография: AES и режимите на работа", sv: "Symmetrisk kryptografi: AES och driftsätten", fi: "Symmetrinen kryptografia: AES ja toimintatavat", id: "Kriptografi simetris: AES dan mode operasi", th: "การเข้ารหัสแบบสมมาตร: AES และโหมดการทำงาน", sw: "Ulinganifu wa cryptography: AES na njia za uendeshaji",
  },
  content: {
...
const lecture05: Explanation = {
  ...
  lesson: 5,
  title: {
    de: "Asymmetrische Kryptografie: das RSA-Kryptosystem", en: "Asymmetric cryptography: the RSA cryptosystem", tr: "Asimetrik şifreleme: RSA şifreleme sistemi", ar: "التشفير غير المتماثل: نظام التشفير RSA", ru: "Асимметричная криптография: криптосистема RSA", it: "Crittografia asimmetrica: il sistema crittografico RSA", es: "Criptografía asimétrica: el criptosistema RSA", fr: "Cryptographie asymétrique : le cryptosystème RSA", zh: "非对称密码学：RSA 密码系统", pl: "Kryptografia asymetryczna: kryptosystem RSA", pt: "Criptografia assimétrica: o criptossistema RSA", uk: "Асиметрична криптографія: криптосистема RSA", fa: "رمزنگاری نامتقارن: سیستم رمزنگاری RSA", ja: "非対称暗号化: RSA 暗号化システム", ko: "비대칭 암호화: RSA 암호화 시스템", vi: "Mật mã bất đối xứng: hệ thống mật mã RSA", hi: "असममित क्रिप्टोग्राफी: आरएसए क्रिप्टोसिस्टम", ur: "غیر متناسب خفیہ نگاری: RSA کرپٹو سسٹم", nl: "Asymmetrische cryptografie: het RSA-cryptosysteem", el: "Ασύμμετρη κρυπτογραφία: το κρυπτοσύστημα RSA", cs: "Asymetrická kryptografie: kryptosystém RSA", hu: "Aszimmetrikus kriptográfia: az RSA titkosítási rendszer", ro: "Criptografia asimetrică: criptosistemul RSA", sq: "Kriptografia asimetrike: kriptosistemi RSA", sr: "Асиметрична криптографија: РСА криптосистем", hr: "Asimetrična kriptografija: RSA kriptosustav", bg: "Асиметрична криптография: криптосистемата RSA", sv: "Asymmetrisk kryptografi: RSA-kryptosystemet", fi: "Epäsymmetrinen kryptografia: RSA-salausjärjestelmä", id: "Kriptografi asimetris: kriptosistem RSA", th: "การเข้ารหัสแบบอสมมาตร: ระบบการเข้ารหัส RSA", sw: "Usimbaji fiche usiolinganishwa: mfumo wa siri wa RSA",
  },
  content: {
