# CySec2026_Exercise_01_Solutions
...
## 1. https://www.cryptool.org/de/ct2/downloads
## 2. Chiffrat: Xjmw ljjmwyj Ifrjs zsi Mjwwjs, Bnqptrrjs gjn ijw atwqjxzsl kzjw HDgjwxnhmjwmjny. bnw
xyfwyjs rny jnsjw pqfxxnxhmjs Hmnkkwj Hfjxjfw. Zsi szs jns xhmtjsjx enyfy Ats Lfnzx Ozqnzx

Hfjxfw. Ifx gjxyj Lqühp, jns xhmösjw Gqnhp, jns pqzljw XhmjwE, jns wjiqnhm MjwE.

## 3. • Haufigkeitsanalyse vom Plaintext:
- Haufigkeitsanalyse vom Ciphertext:
...
## 4. Wählen wir z.B einen anderes k so können wir eine Verschiebung der Häufigkeiten beobachten.
## 5. • Jede Sprache hat eine individuelle Häufigkeitsverteilung.
- Je länger die Texte werden desto näher kommen wir an die Häufigkeitstabelle dran, längere
Texte haben mehr statistische Informationen.
...
## 1. Entschlüsselt wird durch das umkehren der Permutation, z.B in der Verschlüsselung wird Spalte 1
zu Spalte 3, dann wird in der Entschlüsselung Splate 3 zu Spalte 1.
...
## C S I
## L O O
Schlüssel k = `SEC`, alphabetisch Sortiert k = `CES` C R Y

## P T O
## I S C
## O O L
Beobachtung: Spalte 1 wird zu Spalte 3 und Spalte 3 zu Spalte 1.

### Plaintext: CRYPTOISCOOL
3
...
## 1. Ciphertext: Ugdlvjakjlvywqvzzfjtgzyey
## 2. • Beispiel 1:
Plaintext: Warum schreibe ich diese Zeilen? – Wozu sollen sie dienen? – Was weiß ich selbst

davon? Das ist ziemlich dumm, meine ich, von den Menschen den Grund für ihre Handlungen

und ihre Schreibereien zu verlangen. – Wißt ihr denn selbst, warum ihr die elenden Blätter

aufschlagt, die die Hand eines Narren bekritzelt.

Ciphertext: Oitbq juptlmsw qeo hzwag Gizdmp? – Dsqm aqspvf akl hzwvgu? – Ark egpß

mtz agsfjl lccse? Viu pwk rqgtpzup fbqd, emkui zup, xvr uwv Olrjupgu hvf Otbru xüz kovv

Zipkplfogu yev qjyi Juptlmswzgpie rc xlvcsvilr. – Naßb kov uwvp zictav, deimu kov uam

gsievmp Ipäklmt hywkkjsexl, lkl hzw Pcuh vavgz Rrjzgu fvczkadvdb.

- Beispiel 2:
Plaintext: Wie schön haben’s doch die Ameisen! Sie gehen den ganzen Tag spazieren, freuen

sich des Lebens, müssen nicht lernen und kennen keine Prüfungen. Wenn ich doch nur auch

eine Ameise wäre!« Und schwupps, ist der Wunsch des kleinen Max in Erfüllung gegangen.

Ciphertext: Oqg zgyöf pciie’k lqjl uam Ctizkmp! Zmv ymjlr uwv ihrqwv Vhk jhibpiiwv, hyilwv

upgy vmu Siswvu, tüwjwv ppgyl tgyrvf cpk ovfvgu ovavg Wvüwmvilr. wvp pgy vweo rlj iwjl

vavg Hqvaag dävv!« Mvf zgyocrww, zkb flv Nmvujl uwa msizfmp Teo av Gyjücdcpn kvyipnie.
...
Bemerkung: Verschiebung ist nicht wie bei Caeser, sondern es wird permutiert.
